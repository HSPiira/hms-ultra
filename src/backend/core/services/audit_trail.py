...
class AuditExporter(IAuditExporter):
    ...
    def export_audit_trail(
        ...
        try:
            if format_type == 'CSV':
                export_path = self._export_to_csv(start_date, end_date)
                return {
                    'success': True,
                ...
                export_path = self._export_to_json(start_date, end_date)
                return {
                    'success': True,
            ...
            return {
                'success': False,
                'message': f'Export failed - validation error: {str(e)}',
...
class AuditTrailService:
    ...
    def export_audit_trail(self, start_date: date, end_date: date, format_type: str) -> Dict[str, Any]:
        """Export audit trail"""
